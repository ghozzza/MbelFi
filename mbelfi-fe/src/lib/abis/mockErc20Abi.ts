export const mockErc20Abi = [
  {
    inputs: [
      { internalType: "address", name: "_helperTestnet", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_bridgeTokenSender", type: "address" },
    ],
    name: "addBridgeTokenSender",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "getBridgeTokenSendersLength",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
